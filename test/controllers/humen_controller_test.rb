...
class HumenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create human" do
    assert_difference("Human.count") do
      post humen_url, params: { human: { email: @human.email, name: @human.name, password: @human.password, password_confirmation: @human.password_confirmation } }
    end
  ...
  test "should update human" do
    patch human_url(@human), params: { human: { email: @human.email, name: @human.name, password: @human.password, password_confirmation: @human.password_confirmation } }
